...
<form action="./TeamList.jsp">
    ...
    <div class="container">
      ...
      <div class="row">
      	<div>
          <h2>회원가입 성공</h2>
		  <p>회원님의 가입을 진심으로 축하드립니다.</p><br><br>
		  </div>
        </div>
        <div class="row">
        	<div>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 해당하는 회원정보에 추후 문제가 발생하면 경고없이 삭제됩니다.</p>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 해당하는 회원정보를 이용해 문제가 발생하면 경고없이 삭제됩니다.</p>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 문제 발생 시 회원가입 이용약관에 의거 포인트 회수 및 정지처리 됩니다.</p>
        
        	</div>
        </div>
      <!-- /.row -->
		<div class="row">
			<h6 class="mt-4">회원가입을 마치고 게시글 리스트를 확인 하시겠으면 이동하세요.
			</h6>
			 <p>
