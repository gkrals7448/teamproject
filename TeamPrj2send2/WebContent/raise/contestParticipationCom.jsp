...
<form action="./MyPage.jsp">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="nav-item" href="./maintest1.jsp">True & False</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="./TeamList.jsp">공모전
                <span class="sr-only">(current)</span>
              </a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="./raise.jsp">공모전개최
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./login_user.jsp">로그인</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row">
      	<div>
          <h2>공모전 참여 성공</h2>
		  <p>회원님의 공모전 참여를 진심으로 축하드립니다.</p><br><br>
		  </div>
        </div>
        <div class="row">
        	<div>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 해당하는 참여글에 추후 문제가 발생하면 경고없이 삭제됩니다.</p>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 해당하는 참여글을 이용해 문제가 발생하면 경고없이 삭제됩니다.</p>
        		<p><img class="checkimg"src="./../resources/png/checkIMG.png"> 문제 발생 시 공모전 참여 이용약관에 의거 포인트 회수 및 정지처리 됩니다.</p>
        
        	</div>
        </div>
      <!-- /.row -->
		<div class="row">
			<h6 class="mt-4">공모전 참여를 마치고 회원님의 참여활동을 확인하고자 하면 이동하세요.
			</h6>
			 <p>
             <input type="submit" class="btn btn-primary btn-lg" value="마이페이지&raquo;"> 
          </p>
		</div>
